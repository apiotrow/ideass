...
public class LSystemsD : MonoBehaviour {
	...
	public GameObject iniPosObject;
	...
	void SetupCone(){
		...
		iniPos = new Vector3(iniPosObject.transform.position.x, segLength, iniPosObject.transform.position.z);

		//iniPos2 = new Vector3(0f,segLength,0f);
		iniPos2 = new Vector3(iniPosObject.transform.position.x, segLength, iniPosObject.transform.position.z);
